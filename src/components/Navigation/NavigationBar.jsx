 ...
 *
 * @returns {Array} - Parsed array of shipment objects from localstorage.
 */
...
function ResponsiveDrawer(props) {
   ...
   */
	const savePressed = () => {
		localStorage.setItem(
			'businesses',
			JSON.stringify(shipments.getShipments()),
		);
	};
  /**
   * Loads all data from shipments array, when load is pressed.
   */
	const loadPressed = () => {
  ...
  /**
   * Updates the state of the search value and returns corresponding objects.
   *
   * @param {Event} e - typing event on input
   */
	const handleSearch = (e) => {
		const inputValue = e.target.value.toLowerCase();
		setData(
			inputJson.filter((business) =>
			...
			<main className={classes.content}>
				...
				{data === null ? (
					<div className={classes.loadPage}>
						...
						<div>
							<Button variant="contained" color="primary" onClick={loadPressed}>
								<InputIcon />
