...
export default function Business(props) {
	...
	/**
	 * Update shipments boxes value.
	 *
	 * @param {} e - typing event.
	 */
	const updateShipment = (e) => {
		setBox(e.target.value);
		shipments.getShipments().find((s) => s.id === id).boxes = e.target.value;
	};
		...
		<div style={styles.root}>
			...
			<div style={styles.card}>
				<Paper elevation={2} style={styles.paper}>
					<div style={{ margin: '1em' }}>Number of required cargo bays</div>
...
const styles = {
	...
	paper: {
		...
		width: 200,
		background: 'linear-gradient(to right bottom, #607d8b, #90a4ae)',
		color: '#fff',
		fontWeight: 'bolder',
	},
};
